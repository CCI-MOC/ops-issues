---
name: Broken Hardware Report
about: Post an issue about a broken node in the MOC
title: 'Broken Hardware: [ESI NODE LABEL]'
labels: ''
assignees: hakasapl
...
* Ticket Vendor (Lenovo, Dell, etc.):
* Ticket Number: ``
* Primary Contact Email on the Ticket: ``
